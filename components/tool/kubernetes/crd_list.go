...
func NewCustomResourceDefinitionListTool(ctx context.Context, configs Configs) (tool.InvokableTool, error) {
	return NewListTool(ctx, configs, "kubernetes_list_customresourcedefinitions", customResourceDefinitionListDescription, &apiextensionsv1.CustomResourceDefinitionList{}, &CustomResourceDefinitionListOutput{}, nil)
}
