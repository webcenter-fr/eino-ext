...
// ClusterListParams defines the parameters for listing Kubernetes clusters.
...
func (t *ClusterListTool) Invoke(ctx context.Context, params *ClusterListParams) (string, error) {
